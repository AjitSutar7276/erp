...
<div class="nano">
        <div class="nano-content">
          ...
          <ul>
            ...
            <li class="label">Marketing</li>
            <li><a class="sidebar-sub-toggle"><i class="ti-user"></i> Company <span class="sidebar-collapse-icon ti-angle-down"></span></a>
              <ul>
            ...
            <li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i>Product<sapn class="sidebar-collapse-icon ti-angle-down"></sapn></a>
                <ul>
                      <li><a href="<?php echo $base_path?>/Product/addProduct.php">Add Product</a></li>
                      <li><a href="<?php echo $base_path?>/Product/Viewproduct.php">View Product</a></li>
                </ul>
            </li>
            ...
            <li><a class="sidebar-sub-toggle"><i class="ti-layout"></i> UI Elements <span class="sidebar-collapse-icon ti-angle-down"></span></a>
              <ul>
                ...
                <li><a href="ui-recent-comments.html">comments</a></li>
            ...
            <li><a class="sidebar-sub-toggle"><i class="ti-panel"></i> Components <span class="sidebar-collapse-icon ti-angle-down"></span></a>
              <ul>
                ...
                <li><a href="uc-carousel-img.html">Carousels</a></li>
				<li><a href="uc-carousel.html">Carousel quote</a></li>
